...
function DashboardCtrl($scope, $rootScope, $http, authService) {
...
//		$rootScope.authenticated = isAuthenticated;
	...
	$scope.getUserInfo = function() {
		authService.getRemoteResourceUser()
		.then(function(response) {
...
DashboardCtrl.resolve = {
	isAuthenticated : function($q, $http) {
		...
		$http({method: 'GET', url: 'oauth/token'})
...
DashboardCtrl.$inject = ['$scope', '$rootScope', '$http', 'AuthService'];
